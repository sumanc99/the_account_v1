...
if(isset($_POST["unupgrade"])){
    ...
    if(!array_filter($errors)){
        ...
        $sql ="UPDATE accounts SET cashout_date='' WHERE acct_id='$acct'";
...
<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>"> 
                ...
                <div class="card-content">
                    <div class="input-field" style=" margin-bottom:0px !important;">
                        ...
                        <div class="right-align">
                             ...
                             <button name="unupgrade"class="btn indigo darken-4 btn-brand z-depth-0">
                             un-upgrade account
                             </button>   
                        </div>
                    </div>
   ...
   <div class="center" style="margin:10px !important;">
        <a href="manager_setting.php" class="btn indigo darken-4 btn-brand z-depth-0 action">
          back
        </a>
    </div>
