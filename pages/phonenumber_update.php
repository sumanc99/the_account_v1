...
if(isset($_POST["update"])){
    ...
    $new_phone =   sanitize($_POST["new"]);
        ...
        if(empty($old_phone)){
            ...
            if(!value_taking($old_phone, 'phonenumber', 'staffs')){
                $errors['old_phone'] = "provide a valid phonenumber";
            }
        }
        ...
        if(empty($new_phone)){
            ...
            if(value_taking($new_phone, 'phonenumber', 'staffs')){
...
if(!array_filter($errors)){
   ...
   $sql ="UPDATE staffs SET phonenumber='$new_phone' WHERE phonenumber='$old_phone'";
   ...
   if(!$sql_query){
    echo "erro".mysqli_error($conn);
     ...
     $sql ="UPDATE users SET phonenumber='$new_phone' WHERE phonenumber='$old_phone'";
     $sql_query = mysqli_query($conn, $sql);
